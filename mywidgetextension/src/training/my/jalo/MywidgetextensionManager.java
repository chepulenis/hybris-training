...
import training.my.constants.MywidgetextensionConstants;
 ...
 */
public class MywidgetextensionManager extends GeneratedMywidgetextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MywidgetextensionManager.class.getName());
	 ...
	 */
	public static MywidgetextensionManager getInstance()
	{
		return (MywidgetextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MywidgetextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MywidgetextensionManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MywidgetextensionManager called.");
		}
	}

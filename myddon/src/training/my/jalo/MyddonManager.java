...
import training.my.constants.MyddonConstants;



/**
 * This is the extension manager of the Myddon extension.
 */
public class MyddonManager extends GeneratedMyddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MyddonManager.class.getName());
	 ...
	 */
	public static MyddonManager getInstance()
	{
		return (MyddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MyddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MyddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MyddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MyddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}

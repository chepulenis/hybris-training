 ...
 */
package training.my.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String CurrentNumberOfUsers = _Prefix + CurrentNumberOfUsersModel._TYPECODE + _Suffix;
			String CurrentNumberOfOrders = _Prefix + CurrentNumberOfOrdersModel._TYPECODE + _Suffix;
		}
	}

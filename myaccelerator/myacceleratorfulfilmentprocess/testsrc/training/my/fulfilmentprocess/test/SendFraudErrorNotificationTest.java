...
import training.my.fulfilmentprocess.actions.order.SendFraudErrorNotificationAction;
...
public class SendFraudErrorNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link training.my.fulfilmentprocess.actions.order.SendFraudErrorNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test

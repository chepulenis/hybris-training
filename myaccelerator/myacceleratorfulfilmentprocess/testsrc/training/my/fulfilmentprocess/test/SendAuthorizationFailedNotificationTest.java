...
import training.my.fulfilmentprocess.actions.order.SendAuthorizationFailedNotificationAction;
...
public class SendAuthorizationFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link training.my.fulfilmentprocess.actions.order.SendOrderPlacedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test

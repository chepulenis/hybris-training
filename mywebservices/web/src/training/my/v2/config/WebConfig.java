 ...
 */
package training.my.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import training.my.constants.YcommercewebservicesConstants;
import training.my.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "mywebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "mywebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "mywebservices.oauth2.tokenUrl";

	private static final String DESC = "mywebservices.v2.description";
	private static final String TITLE = "mywebservices.v2.title";
	private static final String VERSION = "mywebservices.v2.version";
	private static final String LICENSE = "mywebservices.v2.license";
	private static final String LICENSE_URL = "mywebservices.v2.license.url";
